...
namespace QuanLyHocSinh
{
    public partial class AdTableManager : Form
    {
        ...
        private void btUpdateData_Click_1(object sender, EventArgs e)
        {
            LoadListUser();
        }
        ...
        //Manager Teacher
        private void btAddT_Click_1(object sender, EventArgs e)
        {
        ...
        private void btDeleteT_Click_1(object sender, EventArgs e)
        {
            string ma = textMGV.Text;
        ...
        //Manager Student
        private void btAddS_Click_1(object sender, EventArgs e)
        {
        ...
        private void btEditS_Click_1(object sender, EventArgs e)
        {
            string ms = textMHS.Text;
            string name = textNameStudent.Text;
        ...
        private void btDeleteS_Click_1(object sender, EventArgs e)
        {
            string ms = textMHS.Text;
        ...
        //Assigned
        private void btAddAss_Click_1(object sender, EventArgs e)
        {
        ...
        private void btEditAss_Click_1(object sender, EventArgs e)
        {
            string mapc = textMPC.Text;
            string magvl = (string)comboMGV.SelectedValue;
            string mamh = (string)comboMMH.SelectedValue;
        ...
        private void btDeleteAss_Click_1(object sender, EventArgs e)
        {
            string mapc = textMPC.Text;
        ...
        private void btDeleteGVL_Click_1(object sender, EventArgs e)
        {
            string mgvl = tbMGVL.Text;
        ...
        private void btUpdateGVL_Click_1(object sender, EventArgs e)
        {
            string mgvl = tbMGVL.Text;
            string mgv = (string)cbxMGV.SelectedValue;
            string ml = (string)cbxML.SelectedValue;
        ...
        private void dataManagerUser_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
           
        }

        private void dataManagerStudent_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
